...
val words = listOf("КОМПОЗИТОР", "КАРНИЗ", "ЛОБОТОМИЯ", "САНАТОРИЙ", "РЕВИЗОР", "ЛАВАНДА", "ВЫДРА","РЕБЕНОК","ПАРИК","ЛОДКА","БОЛЬНИЦА","ОДИНОЧЕСТВО","ПОЭТ","МОЛНИЯ","ПЕЛЬМЕНИ","ВИТРАЖ","МАРКЕР","ВИТРИНА","СЕМЕЧКИ","КУРИЦА","СПОРТСМЕН","ПАРАД")
